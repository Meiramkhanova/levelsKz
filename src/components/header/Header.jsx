...
export default function Header() {
  ...
  const [modalSearchCompanyActive, setModalSearchCompanyActive] =
    useState(false);
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar
        position="static"
        style={{
          backgroundColor: theme === "light" ? "#285975" : "#09192F",
      ...
      >
        <Container>
          ...
          >
            <Box sx={{ display: "flex", height: "80px", alignItems: "center" }}>
              ...
              <Paper
                ...
                className={`searchInput ${
                  modalSearchCompanyActive ? "active" : ""
                }`}
              >
            ...
            <BedtimeIcon onClick={handleThemeToggle} />
          </Box>
        </Container>
      </AppBar>
    </Box>
